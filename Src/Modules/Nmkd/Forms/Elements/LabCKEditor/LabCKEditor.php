...
namespace Src\Modules\Nmkd\Forms\Elements\LabCKEditor;

use PFBC\Element\CKEditor;
use App\Core\Router;

class LabCKEditor extends CKEditor {
	protected $basic;
...
JS;
	...
	function getJSFiles() {
            $url = Router::buildUrl('Src/Modules/Nmkd/Forms/Elements/LabCKEditor/ckeditor/ckeditor.js');
